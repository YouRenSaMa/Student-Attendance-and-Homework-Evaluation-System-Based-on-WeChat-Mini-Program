<template>
	<div>
		<div class="center_view">
			<div class="list_search_view">
				...
				<div class="btn_view">
                    ...
                    <el-button class="statis_btn" type="warning" @click="echartClick1" v-if="btnAuth('zuoyepigai','作业等级统计')">
		...
		<el-dialog v-model="echartVisible" title="统计图" width="70%">
            <div  id="dengjiEchart1" style="width:100%;height:600px;"></div>
			<template #footer>
...
<script setup>
	...
	const echartClick1 = ()=>{
		...
		nextTick(()=>{
			var dengjiEchart1 = echarts.init(document.getElementById("dengjiEchart1"),'theme');
			context.$http({
				url: `${tableName}/group/dengji`,
				method: 'get'
			}).then(res=>{
