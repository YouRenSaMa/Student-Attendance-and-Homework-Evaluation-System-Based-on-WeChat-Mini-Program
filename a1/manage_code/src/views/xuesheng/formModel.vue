				...
				<el-row >
					...
					<el-col :span="12">
						<el-form-item label="学生手机" prop="xueshengshouji">
							<el-input class="list_inp" v-model="form.xueshengshouji" placeholder="学生手机"
                                type="text"
								:readonly="!isAdd||disabledForm.xueshengshouji?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='xueshengshouji'){
					form.value.xueshengshouji = row[x];
					disabledForm.value.xueshengshouji = true;
					continue;
				}
				if(x=='banji'){
