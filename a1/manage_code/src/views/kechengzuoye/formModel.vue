		...
		<el-dialog modal-class="edit_form_modal" class="edit_form" v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" :rules="rules">
				<el-row >
					...
					<el-col :span="12">
						<el-form-item label="截止提交时间" prop="reversetime">
							<el-date-picker
								class="list_date"
								...
								placeholder="请选择截止提交时间" />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="作业内容" prop="zuoyeneirong">
							<editor :value="form.zuoyeneirong" placeholder="请输入作业内容" :readonly="!isAdd||disabledForm.zuoyeneirong?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'zuoyeneirong')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.zuoyeneirong = res.data.data.zuoyeneirong?(res.data.data.zuoyeneirong.replace(reg,'../../../cl526311166/file')):'';
