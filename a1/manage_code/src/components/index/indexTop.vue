<template>
	<div class="top_view">
		...
		<div class="projectTitle">基于微信小程序学生考勤和作业评价系统</div>
...
.top_view{
    ...
    background: linear-gradient(180deg, rgba(248,195,155,1) 0%, rgba(255,255,255,1) 100%);
}
/*标题*/
...
.top_view .breadcrumb-view {
    ...
    top: 80px;
    background: #F4F4F4;
    width: calc(100% - 0px - 17px);
    left: 0px;
    height: 40px;
    display: flex;
    align-items: center;
    padding: 0 20px;
    border-bottom: 4px solid #A17B32;
}
</style>