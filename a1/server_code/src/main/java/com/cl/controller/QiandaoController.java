...
public class QiandaoController {
    ...
    public R page(@RequestParam Map<String, Object> params,QiandaoEntity qiandao,
                    ...
                    qiandao.setXuehao((String)request.getSession().getAttribute("username"));
                                    }
    ...
    public R info(@PathVariable("id") Long id){
		...
		qiandao = qiandaoService.selectView(new EntityWrapper<QiandaoEntity>().eq("id", id));
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = MPUtil.snakeListToCamel(qiandaoService.selectValue(params, ew));
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = MPUtil.snakeListToCamel(qiandaoService.selectTimeStatValue(params, ew));
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = MPUtil.snakeListToCamel(qiandaoService.selectGroup(params, ew));
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,QiandaoEntity qiandao, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("xuesheng")) {
            qiandao.setXuehao((String)request.getSession().getAttribute("username"));
        }
        EntityWrapper<QiandaoEntity> ew = new EntityWrapper<QiandaoEntity>();
        int count = qiandaoService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, qiandao), params), params));
