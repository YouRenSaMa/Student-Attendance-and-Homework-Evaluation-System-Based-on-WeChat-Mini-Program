...
if(o=='xueshengshouji'){
    refobjempty["xueshengshouji"]=obj[o]
ro.xueshengshouji = true;
continue;
}else{
}
...
if(o=='mima') {
dataEmpty["mima"] = data[o]
}
if(o=='xueshengxingming') {
dataEmpty["xueshengxingming"] = data[o]
}
if(o=='xueshengshouji') {
dataEmpty["xueshengshouji"] = data[o]
}
if(o=='banji') {
dataEmpty["banji"] = data[o]
}
if(o=='touxiang') {
dataEmpty['touxiang'] = data[o];
dataEmpty['touxiangPath'] = baseURL + data[o].split(",")[0];
}
}
...
const valuexueshengshouji = this.data.xueshengshouji;

if (!mobilePattern.test(valuexueshengshouji)) {
wx.showToast({
icon: "none",
title: `学生手机应输入手机格式`,
})
...
let corssRes = await list(`xuesheng`, params)
crossoptnum = wx.getStorageSync('statusColumnName');
