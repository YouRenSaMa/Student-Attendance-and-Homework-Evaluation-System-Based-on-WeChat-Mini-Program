...
if(o=='qiandaorenshu'){
    refobjempty["qiandaorenshu"]=obj[o]
ro.qiandaorenshu = true;
continue;
}else{
}
...
if(o=='qiandaorenshu') {
dataEmpty["qiandaorenshu"] = data[o]
}
if(o=='crossuserid') {
...
qiandaorenshu: this.data. qiandaorenshu,
...
let corssRes = await list(`qiandao`, params)
crossoptnum = wx.getStorageSync('statusColumnName');
